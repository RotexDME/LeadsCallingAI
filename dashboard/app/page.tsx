...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-4 relative overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-10vh] right-[20vw] w-[60vh] h-[60vh] bg-cyan-600/15 rounded-full blur-[128px] animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="z-10 flex flex-col items-center gap-12 w-full max-w-7xl">
        <header className="text-center space-y-4 animate-in fade-in slide-in-from-top-8 duration-700">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-cyan-300 mb-4">
          ...
          <h1 className="text-6xl md:text-7xl font-extrabold tracking-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500"> AI</span>
          </h1>
